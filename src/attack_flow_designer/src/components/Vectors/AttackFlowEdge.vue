...
export default defineComponent({
  ...
  computed: {
    svgPath(): string {
      ...
      if (this.target === null || this.source === null) return "";
    ...
    source_x0(): number {
      return this.source?.x0 - this.padding;
    },
    source_y0(): number {
      return this.source?.y0 - this.padding;
    },
    source_x1(): number {
      return this.source?.x1 + this.padding;
    },
    source_y1(): number {
      return this.source?.y1 + this.padding;
    },
    target_x0(): number {
      return this.target?.x0 - this.padding;
    },
    target_y0(): number {
      return this.target?.y0 - this.padding;
    },
    target_x1(): number {
      return this.target?.x1 + this.padding;
    },
    target_y1(): number {
      return this.target?.y1 + this.padding;
    },
  },
});
</script>
...
class AttackFlowValidator extends DiagramValidator {
    ...
    static stixObservable = /^artifact|directory|file|mutex|process|software|user_account|windows_registry_key|x509_certificate|autonomous_system|domain_name|email_addr|email_message|ipv4_addr|ipv6_addr|mac_addr|network_traffic|url$/;

...
import { Alignment, BlockView, LineView } from "@OpenChart/DiagramView";
import { findImplicitSelection, traverse } from "@OpenChart/DiagramModel";
import type { DiagramObjectView } from "@OpenChart/DiagramView";

export class BlockAndLineMoverPlugin extends SelectPlugin {
    ...
    /**
     * Creates a new {@link BlockAndLineMoverPlugin}.
     * @param ui
    ...
    public canHandleSelection(obj: DiagramObjectView | undefined, event: MouseEvent): boolean {
        return obj instanceof BlockView || obj instanceof LineView;
    }

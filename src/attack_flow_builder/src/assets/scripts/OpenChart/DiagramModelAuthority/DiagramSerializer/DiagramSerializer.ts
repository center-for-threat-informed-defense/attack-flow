...
export class DiagramSerializer {
    ...
    public exportObjects(
        ...
        return { schema: factory.id, objects: [...exportMap.values()] };
    }
     ...
     */
    protected yieldExportFromDiagramObject(
        obj: DiagramObject,
     ...
     *  The current export map.
     */
    protected yieldExportFromAnchor(
        anchor: Anchor,
     ...
     *  The current export map.
     */
    protected yieldExportFromBlock(
        block: Block,
        exportMap: Map<string, DiagramObjectExport>
    ) {
     ...
     *  The current export map.
     */
    protected yieldExportFromGroup(
        group: Group,
        exportMap: Map<string, DiagramObjectExport>
    ) {
        // Yield object
     ...
     *  The current export map.
     */
    protected yieldExportFromGenericObject(
     ...
     *  The diagram export.
     */
    protected toGenericObjectExport(obj: DiagramObject): GenericObjectExport {
     ...
     */
    protected yieldImportFromDiagramObject<T extends DiagramObject>(
        id: string,
     ...
     */
    protected yieldImportFromAnchor(
     ...
     *  `template` must match the export's template.
     */
    protected yieldImportFromBlock(
     ...
     *  `template` must match the export's template.
     */
    protected yieldImportFromGroup(
     ...
     */
    protected yieldImportFromGenericObject(
     ...
     */
    protected assertExportType<T extends keyof TypeToExport>(

...
import { DiagramObjectType, PropertyType } from ".";
import {
    Anchor, Block, DateProperty, DictionaryProperty,
    EnumProperty, FloatProperty, Group, Handle, IntProperty,
    Latch, Line, ListProperty, Property, RootProperty,
    StringProperty
} from "../../DiagramModel";
import type { DiagramObject, JsonEntries, JsonType } from "../../DiagramModel";
import type {
    AtomicPropertyDescriptors, Constructor, DiagramObjectTemplate,
...
export class DiagramObjectFactory {
    ...
    /**
     * The factory's schema identifier.
     */
    public readonly id: string;

    /**
     * The factory's page template.
     */
    ...
    constructor(schema: DiagramSchemaConfiguration) {
        this.id = schema.id;
        this.page = schema.page_template;
        this.templates = new Map(schema.templates.map(o => [o.name, o]));
    }
    ...
    public createNewDiagramObject<T extends DiagramObject>(
        ...
        // Create object
        const template = typeof param1 === "string" ?
            this.resolveTemplate(param1) : param1;

...
import { traversePostfix } from "../../DiagramNavigators";
import { SemanticRole, SemanticRoleMask } from "../../SemanticAnalysis";
import { DiagramObjectFactory, DiagramObjectType } from "../../DiagramModelAuthority";
import {
    AnchorPoint, AnchorView, BlockView, BranchBlock,
    DictionaryBlock, GroupFace, GroupView, HandlePoint,
    HandleView, HorizontalElbowLine, LatchPoint, LatchView,
    LineView, TextBlock
} from "../../DiagramView";
...
} from "../../DiagramModelAuthority";

export class DiagramViewFactory extends DiagramObjectFactory {

    /**
     * The factory's theme.
     */
    public readonly theme: DiagramTheme;
    ...
    private resolveDesign(template: string): FaceDesign {
        if (template in this.theme.faces) {
            return this.theme.faces[template];
        } else {

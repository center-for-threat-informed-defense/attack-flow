import type { AttackFlowObjectType, StixDomainObjectType } from "./StixDomainObjectType";
import type { ExternalReference, GranularMarking } from "../StixCommonDataTypes";

/**
 * Base STIX 2.1 Domain Object.
 */
export interface BaseStixDomainObject<
    T extends StixDomainObjectType | AttackFlowObjectType = StixDomainObjectType | AttackFlowObjectType
> {

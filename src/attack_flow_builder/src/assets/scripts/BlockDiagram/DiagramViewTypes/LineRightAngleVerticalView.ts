...
export class LineRightAngleVerticalView extends DiagramLineView {

    /**
     * The underlying model.
     */
    public override el: LineRightAngleVerticalModel;

    /**
     * Creates a new {@link LineRightAngleVerticalView}.
     * @param el
     *  The underlying model.
     * @param rasterCache
     *  The view's raster cache.
     */
    constructor(el: LineRightAngleVerticalModel, rasterCache: RasterCache) {

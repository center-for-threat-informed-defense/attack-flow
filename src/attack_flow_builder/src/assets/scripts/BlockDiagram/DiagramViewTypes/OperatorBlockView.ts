...
import { OperatorBlockModel } from "../DiagramModelTypes";
import { DiagramObjectView } from ".";
import { Select, SelectMask } from "../Attributes";

export class OperatorBlockView extends DiagramObjectView {
    
    /**
     * The underlying model.
     */
    public override el: OperatorBlockModel;
     ...
     */
    constructor(el: OperatorBlockModel, rasterCache: RasterCache) {
    ...
    public override renderTo(
        ...
        ctx.fillText(tf.t, x + tf.x, y + tf.y)
     ...
     *  The view.
     */
    public override updateView(): OperatorBlockView {
        // Update view
        super.updateView();

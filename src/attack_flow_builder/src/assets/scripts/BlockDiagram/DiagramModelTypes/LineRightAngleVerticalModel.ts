...
import { LineRightAngleVerticalView } from "../DiagramViewTypes/LineRightAngleVerticalView";
...
export class LineRightAngleVerticalModel extends DiagramLineModel {

    /**
     * The template the object was configured with.
     */
    public override readonly template: LineRightAngleVerticalTemplate;

    /**
     * The line's hitboxes.
     *  [0] = The vertical segment's hitbox.
     *  [1] = The vertical segment's hitbox.
     */
    public readonly hitboxes: number[][];

    /**
     * Creates a new {@link LineRightAngleVerticalModel}.
     * @param factory
    ...
    constructor(
        ...
        template: LineRightAngleVerticalTemplate,
    ...
    public override updateLayout(reasons: number, updateParent: boolean = true) {
        ...
        this.hitboxes[0] = getLineHitbox(e1.xMid, e1.yMid, e1.xMid, e2.yMid, w);
        this.hitboxes[1] = getLineHitbox(e1.xMid, e2.yMid, e2.xMid, e2.yMid, w);
        super.updateLayout(reasons, updateParent);
    }

    public createView(cache: RasterCache): LineRightAngleVerticalView {
        return new LineRightAngleVerticalView(this, cache);
    }
}

...
Attack Flow represents the linkage of adversary behavior for a given attack flow. The type, description, and
required attributes of each field are provided in the subsequent sections along with an example.

![Entity diagram for Attack Flow](model.png)
...
<!--JSON_SCHEMA Generated by `generate_schema_docs.py` at 2021-12-17T13:46:45.296037Z-->
...
This Attack Flow maps the Tesla incident report into the Attack Flow schema. This mapping is based on multiple
sources, including [ZDNet's coverage of the
incident](https://www.zdnet.com/article/tesla-systems-used-by-hackers-to-mine-cryptocurrency/).

![Tesla incident report](../data/action-object-tesla.png)

The repository contains [a corpus of incident reports](../corpus/) mapped into the Attack Flow language.

...
<!--JSON_SCHEMA Generated by `generate_schema_docs.py` at 2021-10-21T10:48:21.382553Z-->
...
<table>
  ...
  <tr>
    <td>meta</td>
    <td><a href="#meta">meta</a> object</td>
    <td>Yes</td>
...
<table>
  ...
  <tr>
    ...
    <td>enum</td>
    <td>Yes</td>
    <td>Indicate whether this is an Attack Flow or a Pattern. (Enum values: "attack-flow", "attack-flow-pattern")</td>
  </tr>
  <tr>
    <td>id</td>
    <td>string (format: uuid)</td>
    <td>Yes</td>
    <td>The identifier for this Attack Flow or Pattern. MUST be unique within this document. TODO: Ideally is unique among Attack Flows produced by a particular organization.</td>
  </tr>
  <tr>
    <td>name</td>
    <td>string</td>
    <td>Yes</td>
    <td>The name of the Attack Flow or Pattern.</td>
  </tr>
  <tr>
    <td>created</td>
    <td>string (format: date-time)</td>
    <td>Yes</td>
    <td>Creation time of the Attack Flow or Pattern. (RFC-3339 format, e.g. YYYY-MM-DDThh:mm:ssZ)</td>
  </tr>
  <tr>
    <td>author</td>
    <td>string</td>
    <td>No</td>
    <td>The author of the Attack Flow or Pattern.</td>
  </tr>
  <tr>
    <td>description</td>
    <td>string</td>
    <td>No</td>
    <td>The description of the Attack Flow or Pattern.</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>No</td>
    <td>The list of properties associated with this action object.</td>
  </tr>
  <tr>
    <td>succeeded</td>
    <td>number</td>
  ...
  <tr>
    ...
    <td>enum</td>
    <td>Yes</td>
    <td>`AND` means that all input nodes/trees must be true in order for this Action to succeed. `OR` means that one input node/tree must be true in order for this Action to succeed. The returned &#x27;success&#x27; state should match the &#x27;state&#x27; used on assets. TBD extension point (Enum values: "attack-flow", "attack-flow-pattern")</td>
  </tr>
</table>
...
<table>
  ...
  <tr>
    ...
    <td>string (format: uuid)</td>
    <td>Yes</td>
    <td>The identifier for this Relationship or Patter. MUST be unique within this document.</td>
  </tr>
  <tr>
    <td>label</td>
    <td>string</td>
  ...
  <tr>
    ...
    <td>string (format: uuid)</td>
    <td>Yes</td>
    <td>The source Action ID or Asset ID for this relationship.</td>
  </tr>
  <tr>
    <td>destination</td>
    <td>string (format: uuid)</td>
    <td>Yes</td>
    <td>The destination Asset ID or Action ID for this relationship. If the source is an Action, this MUST be an Asset. If the source is an Asset, this MUST be an Action.</td>
  </tr>
</table>

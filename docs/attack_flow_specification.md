...
| version | Date | yes | The version of the attack flow format used in this file. |
| created | Date | yes | Creation time of this file.<br /> Format:  2021-01-01 |
| modified | String | no | Last modified time of this mapping file.<br /> Format:  2021-01-01 |
...
| object_ref	| List of IDs | no | The list of steps and relationships referred to by this report.|
...
comments: >-
  A quick draft using Version 0.2 of this model and the Tesla breach described in
